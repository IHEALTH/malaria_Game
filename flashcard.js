...
(function() {
    ...
    FlashCards.prototype.enableButtons = function() { //enable answear buttons
        ...
        divanswer1.style.display = "inline";
       divanswer2.style.display = "inline";
  ...
  var divanswer;
                divanswer=  document.getElementById("card-answer");
        var divanswer1;
               divanswer1 = document.getElementById("card-answer1");      
        var divanswer2;
              divanswer2  = document.getElementById("card-answer2");
         var clonecarddivanswer;
                clonecarddivanswer =  document.getElementById("clonecard--answer");
        var clonecarddivanswer1;
                clonecarddivanswer1= document.getElementById("clonecard--answer1");      
        var clonecarddivanswer2;
                clonecarddivanswer2= document.getElementById("clonecard--answer2");
    ...
    FlashCards.prototype.randomise = function() {
        ...
        if (r === 1) {
           ...
           divanswer.style.top = "1px";
            document.getElementById("clonecard-answer").style.top = "1px";
            divanswer1.style.top = "50px";
            document.getElementById("clonecard-answer1").style.top = "50px";
           divanswer2.style.top = "-50px";
            document.getElementById("clonecard-answer2").style.top = "-50px";
            
           divanswer.setAttribute("class","middle") ;
           divanswer1.setAttribute("class","bottom") ;
             divanswer2.setAttribute("class","top") ; 
        } else if (r === 2) {
            
            divanswer.style.top = "50px";
            document.getElementById("clonecard-answer").style.top = "50px";
            divanswer1.style.top = "-50px";
            document.getElementById("clonecard-answer1").style.top = "-50px";
           divanswer2.style.top = "1px";
            document.getElementById("clonecard-answer2").style.top = "1px";
            
           
             
                 
           divanswer.setAttribute("class","bottom") ;
           divanswer1.setAttribute("class","top") ;
             divanswer2.setAttribute("class","middle") ; 
        } else if (r === 3) {

            divanswer.style.top = "-50px";
            document.getElementById("clonecard-answer").style.top = "-50px";
            divanswer1.style.top = "1px";
           ...
           divanswer2.style.top = "50px";
            document.getElementById("clonecard-answer2").style.top = "50px";
              ...
              divanswer.setAttribute("class","top") ;
           divanswer1.setAttribute("class","middle") ;
             divanswer2.setAttribute("class","bottom") ; 
    ...
    FlashCards.prototype.setShapeDeck = function() {
       ...
       divanswer2.style.color = "#996600";//change
       divanswer2.innerHTML = this.deckAnswer[this.cardCount + offset +3];//change
    };
    ...
    FlashCards.prototype.setCountingDeck = function() {
        ...
        divanswer.innerHTML = this.deckAnswer[this.cardCount];
        divanswer1.style.color = "#996600";//change
        divanswer1.innerHTML = this.deckAnswer[this.cardCount ];//change
       divanswer2.style.color = "#996600";//change
       divanswer2.innerHTML = this.deckAnswer[this.cardCount ];//change
    };
    ...
    FlashCards.prototype.setColorDeck = function() {
        ...
        divanswer.innerHTML = this.colorAnswer[this.cardCount];
        //divanswer.style.color = this.colorHex[this.cardCount];
        divanswer1.style.color = "#996600";//change
        divanswer1.innerHTML = this.deckAnswer[this.cardCount ];//change
       divanswer2.style.color = "#996600";//change
       divanswer2.innerHTML = this.deckAnswer[this.cardCount ];//change
      ...
      this.PauseAnswer();
        ...
        if (!this.isLastCard()) {
            ...
            //offset
               var offset = this.deckAnswer.length / this.number_of_answers; //change
            divanswer.innerHTML = this.deckAnswer[this.cardCount];
             divanswer1.innerHTML = this.deckAnswer[this.cardCount +offset];
              divanswer2.innerHTML = this.deckAnswer[this.cardCount +offset +3];
 ...
 function playRightAnswer(wrongAnswer){
    ...
    /**
     * FlashCards.replayButt
onClicked() restarts current game and calls clear()
     * @private
     */
    ...
    FlashCards.prototype.setGameEventListeners = function() {
        ...
        divanswer1.addEventListener('click', function() {
       ...
       divanswer2.addEventListener('click', function() {
            self.wrongButtonClicked();
            self.cardClicked();
      ...
      if( ($(this).hasClass('onbackground_music'))){
          document.getElementById('sound-intro').pause();
          
          $(this).addClass('offbackground_music').removeClass('onbackground_music');
      } else{
            document.getElementById('sound-intro').play();
          $(this).addClass('onbackground_music').removeClass('offbackground_music');
    ...
    function AudioArray(PlayOptionsAnswer){
        ...
        var topArrtstyle = topArrtcard.style.top;
     ...
     function PlayOptions() {
       ...
       {
           //highlight divs as they are being read out 
             $(document).ready(function(){
           $("div").each(function(){
            ...
            $("#card-answer").css("color", "#996600");
             $("#card-answer1").css("color", " #996600");
             $("#card-answer2").css("color", " #996600");   
        }
